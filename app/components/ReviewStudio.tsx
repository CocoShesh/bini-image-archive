...
export default function ReviewStudio() {
  ...
  return <main className="rs-app">
    ...
    {mode === 'reports' ? <section className="rs-reports-page"><div className="rs-page-head">
  <div>
    <div className="rs-eyebrow">COMMUNITY MODERATION</div>
    <h1>Reports</h1>
    <p>
      {reports.length
